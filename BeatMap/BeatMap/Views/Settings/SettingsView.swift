...
// BeatMap
//
// Version: 1.2.0 (Enhanced Theme Selection)
...
struct SettingsView: View {
    ...
    var body: some View {
        NavigationView {
            ZStack {
                ...
                Form {
                    ...
                    // Appearance - Enhanced Theme Selection
                    Section(header: Text("Appearance")) {
                        ForEach(Theme.allCases) { theme in
                            Button(action: {
                                ...
                                HStack(spacing: 12) {
                                    // Theme icon with accent color preview
                                    ZStack {
        ...
        .alert("Clear All Entries?", isPresented: $showingClearDataAlert, actions: {
            ...
            Text("This will permanently delete all \(journalStore.entries.count) journal entries. This action cannot be undone.")
        })
    ...
    private func clearAllEntries() {
        ...
        LogManager.shared.log("All entries cleared by user", level: .warning)
    }
}

...
struct NewEntryView: View {
    ...
    private func setInitialLocation() {
        ...
        locationManager.requestPreciseLocation { location, locationString in
            if let location = location, let locationString = locationString {
                entryCoordinate = location.coordinate
                entryLocationString = locationString
                print("✅ Precise location set: \(locationString)")
            } else {
                ...
                if let currentCoord = locationManager.currentLocation?.coordinate {
                    ...
                    entryLocationString = locationManager.locationString
